...
import { PostRow, PostType } from '../index'
...
export default {
  ...
  args: {
    ...
    title: 'Погружение в недра. Разбираем kernel exploitation, чтобы добраться до рута на виртуалке c Hack The Box',
...
} as unknown as ComponentMeta<typeof PostRow>
